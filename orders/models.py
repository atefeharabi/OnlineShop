...
class Order(models.Model):
    ...
    payment_status = models.CharField(choices=PAYMENT, max_length=2, default=PAYMENT[1])
    order_status = models.CharField(choices=ORDER_STATUS, max_length=1, default=ORDER_STATUS[2])
